...
namespace FTELSRCore.Extensions
{
    ...
    /// </summary>
    public static class PrecateBuilderExtensions
    {
        /// <summary>
        ...
        /// <summary>
        /// Hàm set giá trị filter IsDeleted.
        /// </summary>
        ...
        public static Expression<Func<T, bool>> AddIsDeleted<T>(bool isDeleted = false)
        {
            ...
            var condition = Expression.Equal(property, Expression.Constant(isDeleted));
